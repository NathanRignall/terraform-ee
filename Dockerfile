...
RUN echo "Adding hashicorp/cloudinit v${CLOUDINIT_PROVIDER_VERSION}" \
    ...
    && curl -LOs https://releases.hashicorp.com/terraform-provider-cloudinit/${CLOUDINIT_PROVIDER_VERSION}/terraform-provider-cloudinit_${CLOUDINIT_PROVIDER_VERSION}_linux_amd64.zip
...
RUN echo "Adding hashicorp/null v${NULL_PROVIDER_VERSION}" \
    ...
    && curl -LOs https://releases.hashicorp.com/terraform-provider-null/${NULL_PROVIDER_VERSION}/terraform-provider-null_${NULL_PROVIDER_VERSION}_linux_amd64.zip
